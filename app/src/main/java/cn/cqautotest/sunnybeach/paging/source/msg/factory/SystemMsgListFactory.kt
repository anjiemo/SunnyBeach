 ...
 */
class SystemMsgListFactory private constructor(msgType: MsgType) : AbstractMsgListFactory(msgType = msgType) {
    ...
    companion object : Creator {
        ...
        override fun create(msgType: MsgType) = SystemMsgListFactory(msgType = msgType)
    }
}