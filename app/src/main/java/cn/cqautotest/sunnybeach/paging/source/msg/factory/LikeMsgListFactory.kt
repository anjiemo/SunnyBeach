 ...
 */
class LikeMsgListFactory private constructor(msgType: MsgType) : AbstractMsgListFactory(msgType = msgType) {
    ...
    companion object : Creator {
        ...
        override fun create(msgType: MsgType) = LikeMsgListFactory(msgType = msgType)
    }
}