...
class UserShareListFragment : AppFragment<AppActivity>(), StatusAction {
    ...
    private val loadStateListener = loadStateListener(mShareListAdapter) { mBinding.refreshLayout.finishRefresh() }
    ...
    override fun initEvent() {
        ...
        mAdapterDelegate.setOnItemClickListener { _, position ->
            // 跳转到分享详情界面
            val item = mShareListAdapter.snapshotList[position] ?: return@setOnItemClickListener
